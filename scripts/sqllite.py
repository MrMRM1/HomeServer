...
class Database:
    def __init__(self):
        ...
        try:
            ...
            self.my_db.execute(f'CREATE TABLE data_user (paths LONGTEXT NULL, port INT DEFAULT {port_flask()}, data_id DEFAULT 1 ,upload DEFAULT "{path_received}", password TEXT NULL, port_ftp INT DEFAULT 8821)')
